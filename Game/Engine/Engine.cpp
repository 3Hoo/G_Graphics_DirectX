...
void Engine::ResizeWindow(int32 width, int32 height)
{
	...
	// 앞에 :: 가 붙어있는 것은 global namespace를 의미한다
	// 없어도 되기는 하지만, 붙이는 것이 좀 더 가독성
	::AdjustWindowRect(&rect, WS_OVERLAPPEDWINDOW, false);			// 왼도우 크기 조절
	::SetWindowPos(_window.hwnd, 0, 100, 100, width, height, 0);	// 왼도우 핸들러로 100, 100에 위치시킴
}
...
void Engine::ShowFPS()
{
	...
	::SetWindowTextW(_window.hwnd, text);
}
